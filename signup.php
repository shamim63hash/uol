		...
		<div class="row">
            <div class="col-md-6">
                <form method="post">
                    ...
                    <input class="form-control" type="text" name="fullname" id="fullname" Required> <br>
                    ...
                    <input class="btn btn-success" type="submit" name="usersubmit" value="Sign Up">
                </form>
            </div>
		    ...
		    <?php
				...
				$query = "insert into tblusers(username,userpassword,name) VALUES('{$_POST['username']}','{$_POST['userpassword']}','{$_POST['fullname']}')";
